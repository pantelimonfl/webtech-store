...
3. In cazul in care autentificarea cu Google a reusit, se va intoarce un obiect JSON cu cateva date despre utilizator (vezi sectiunea GOOOGLE) si un token care va fi transmis server-ului.
